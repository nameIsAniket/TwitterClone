/*
  ...
  - Added the required column `lastNamme` to the `User` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "lastNamme" TEXT NOT NULL,
